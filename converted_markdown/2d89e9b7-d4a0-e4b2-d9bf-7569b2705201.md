...
# cPropFrameSetColdC Method  
  
---  
  
Initializes a cold formed C-type frame section property. If this function is
...
Copy
    ...
    returnValue = instance.SetColdC(Name, 
...
Please refer to [SetColdC_1(String, String, Double, Double, Double, Double,
Double, Boolean, Int32, String,
String)](ca370cee-6679-a4f7-b648-933b4af92294.htm) which has additional
parameters.
