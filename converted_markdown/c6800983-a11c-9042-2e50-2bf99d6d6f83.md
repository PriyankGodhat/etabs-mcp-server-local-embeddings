...
Copy
    ...
    returnValue = instance.GetTube_1(Name, 
    	FileName, MatProp, T3, T2, Tf, Tw, Radius, 
    	Color, Notes, GUID)
...
This function supersedes [GetTube(String, String, String, Double, Double,
Double, Double, Int32, String,
String)](25ab5bf4-2cdf-0863-efea-267ef30561f8.htm).
...
Copy
    ...
    Public Sub Example()
       ...
       'get frame section property data
           ret = SapModel.PropFrame.GetTube_1("TUBE1", FileName, MatProp, t3, t2, tf, tw, Radius, Color, Notes, GUID)
