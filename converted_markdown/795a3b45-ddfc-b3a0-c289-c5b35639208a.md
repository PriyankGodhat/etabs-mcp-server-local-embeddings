...
# cPropFrameSetAngle_1 Method  
  
---  
  
Initializes an angle-type frame section property. If this function is called
...
Copy
    ...
    returnValue = instance.SetAngle_1(Name, 
    	MatProp, T3, T2, Tf, Tw, FilletRadius, 
    	Color, Notes, GUID)
...
This function is obsolete and has been superseded by [SetSteelAngle(String,
String, Double, Double, Double, Double, Double, Boolean, Boolean, Int32,
String, String)](298606d5-2cdd-5a4e-fbdc-86e6b49ebf58.htm) and
[SetConcreteL(String, String, Double, Double, Double, Double, Double, Boolean,
Boolean, Int32, String, String)](a0f102e5-4871-6db9-f048-500f37154439.htm) as
of version 16.0.0. This function is maintained for backwards compatibility.
