...
This function is obsolete and has been superseded by [GetDblAngle_1(String,
String, String, Double, Double, Double, Double, Double, Boolean, Int32,
String, String)](e49a3699-4ed1-caa0-d0b4-d7782b5ff342.htm) as of version
20.4.0. This function is maintained for backwards compatibility.
...
Copy
    ...
    Public Sub Example()
       ...
       'get frame section property data
           ret = SapModel.PropFrame.GetDblAngle("DBANG1", FileName, MatProp, t3, t2, tf, tw, dis, Color, Notes, GUID)
