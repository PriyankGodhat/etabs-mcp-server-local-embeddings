...
# cPropFrameGetConcretePipe Method  
  
---  
  
Retrieves frame section property data for a concrete pipe frame section.
...
Copy
    ...
    returnValue = instance.GetConcretePipe(Name, 
    	FileName, MatProp, Diameter, Tw, Color, 
    	Notes, GUID)
...
Copy
    ...
    Public Sub Example()
       ...
       'set new frame section property
           ret = SapModel.PropFrame.SetConcretePipe("PIPE1", "4000Psi", 30, 4)
    
       'get frame section property data
           ret = SapModel.PropFrame.GetConcretePipe("PIPE1", FileName, MatProp, Diameter, tw, Color, Notes, GUID)
