...
# cDesignConcreteStartDesign Method  
...
Returns zero if the concrete frame design is successfully started; otherwise
it returns a nonzero value.

![](../icons/SectionExpanded.png)Remarks

The function will fail if no concrete frame objects are present. It also will
