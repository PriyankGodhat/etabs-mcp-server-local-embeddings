...
# cAnalysisResultsJointDisplAbs Method  
  
---  
  
Reports the absolute joint displacements for the specified point elements.
Absolute and relative displacements are the same except when reported for time
...
Copy
    ...
    'get joint absolute displacements
        ret = SapModel.Results.JointDisplAbs("ALL", GroupElm, NumberResults, Obj, Elm, LoadCase, StepType, StepNum, U1, U2, U3, R1, R2, R3)
