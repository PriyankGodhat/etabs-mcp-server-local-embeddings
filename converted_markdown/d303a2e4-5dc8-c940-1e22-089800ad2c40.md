...
This item is True if the specified frame object is selected, otherwise it is
False.
...
selected status is set for the frame object specified by the Name item.

If this item is [Group](b6597895-3f27-39aa-33a5-31da1d7662a0.htm), the
selected status is set for all frame objects in the group specified by the
Name item.

If this item is [SelectedObjects](b6597895-3f27-39aa-33a5-31da1d7662a0.htm),
the selected status is set for all selected frame objects and the Name item is
ignored.
