...
Dis
    ...
    Type: [SystemDouble](https://docs.microsoft.com/dotnet/api/system.double)  
This is an array of initial hook opening terms for the link property. The
initial hook opening applies for nonlinear analyses.
...
Copy
    ...
    Public Sub Example()
       ...
       'get link property data
           ret = SapModel.PropLink.GetGap("G1", DOF, Fixed, NonLinear, Ke, Ce, k, dis, dj2, dj3, Notes, GUID)
