...
# cFrameObjSetGUID Method  
  
---  
  
Sets the GUID for the specified frame object. If the GUID is passed in as a
...
Returns zero if the frame object GUID is successfully set; otherwise it
returns nonzero.
